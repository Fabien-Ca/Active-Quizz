...
class mod_activequiz_renderer extends plugin_renderer_base {
    ...
    public function render_quiz(\mod_activequiz\activequiz_attempt $attempt,
        ...
        /****************** modif PRT 2406 ******************/
        // have a quiz stats box to show results statistics.
        $output .= html_writer::div('', 'activequizbox hidden', array('id' => 'quizstatsbox'));
        /**************** Fin modif PRT 2406 ****************/
    ...
    public function render_question_form($slot, $attempt) {
        ...
        $savebtn = html_writer::tag('button', get_string('save', 'activequiz'), array(
                'class'   => 'btn',
                'id'      => 'q' . $qnum . '_save',
    ...
    public function render_controls() {
        ...
        $inqcontrol .= html_writer::tag('button', get_string('show_stats', 'activequiz'), array(
                'class'    => 'btn',
                'id'       => 'togglestats',
                'onclick'  => 'activequiz.toggle_stats();',
                'disabled' => 'true'
            )
        );
