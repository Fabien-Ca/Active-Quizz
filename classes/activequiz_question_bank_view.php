...
class activequiz_question_bank_view extends \core_question\local\bank\view {
    ...
    protected function get_question_bank_plugins(): array {
        ...
        $plugins = array();
        $plugins["qbank_viewquestiontype"] = "\qbank_viewquestiontype\plugin_feature";
        $plugins["qbank_viewquestionname"] = "\qbank_viewquestionname\plugin_feature";
        $plugins["qbank_previewquestion"] = "\qbank_previewquestion\plugin_feature";
        $plugins["qbank_editquestion"] = "\qbank_editquestion\plugin_feature";
