    ...
    public function handle_request() {
        ...
        switch ($this->action) {
            ...
            case 'getcurrentresults': // case to get the results of the question currently going
                ...
                break;
            /****************** modif PRT 2406 ******************/
            case 'getcurrentstats': // case to get the stast of the question currently going

                if ($this->RTQ->is_instructor()) {

                    $responses = $this->session->get_question_stats();
