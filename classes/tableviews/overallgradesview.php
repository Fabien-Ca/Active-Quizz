...
class overallgradesview extends \flexible_table implements \renderable {
    ...
    public function setup() {
        ...
        if ($this->rtq->group_mode()) {
            $columns = array(
                ...
                'rawgrade'        => get_string('grade'),
                'dategraded' => get_string('timemodified', 'activequiz'),
            );
        } else {
            $columns = array(
                'fullname'     => get_string('name'),
    ...
    protected function get_data() {
        ...
        $grades = \mod_activequiz\utils\grade::get_user_grade($this->rtq->getRTQ(), 0, $this->get_primary_sort_order());
        /**************** Fin modif PRT 2406 ****************/
