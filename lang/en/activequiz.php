...
/**************** Fin modif PRT 2406 ****************/
$string['feedbackintro'] = 'Please wait for the instructor to start the next question';
...
$string['show_stats'] = 'Show the distribution of answers';
$string['hide_stats'] = 'Hide the distribution of answers';
